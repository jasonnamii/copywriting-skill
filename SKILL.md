...
- **하는 것** — 카피엔진 v1.4.
- **안 하는 것** — 디자인(→design-skill), 행동(→human-skill), 히트(→hit-skill), BP(→bp-guide).

---

## When to Use

- 사용자가 "카피 써줘", "만들어줘", "진단해줘", "바꿔줘", "힙하게" 같은 표현으로 발동
- 도메인 작업이 필요한 시점
- **안 쓸 때** — 디자인(→design-skill), 행동(→human-skill), 히트(→hit-skill), BP(→bp-guide).
...
| 산출물 | 경로 |
|---|---|
| 주 산출물 | `mnt/outputs/copywriting-skill_{topic}_{YYYY-MM-DD}.md` |
| 형식 | 카피로, 슬로건으로. |
| 리서치 결과 (해당 시) | `{VAULT}/_skills research/copywriting-skill/{YYYY-MM-DD}_{topic}.md` |

## Reference Index

| 파일 | 내용 | 언제 |
|---|---|---|
| `references/benchmarks-app.md` | benchmarks app | 해당 단계 진입 시 |
| `references/benchmarks-crm.md` | benchmarks crm | 해당 단계 진입 시 |
| `references/benchmarks-marketing.md` | benchmarks marketing | 해당 단계 진입 시 |
| `references/benchmarks-strategy.md` | benchmarks strategy | 해당 단계 진입 시 |
| `references/cascade-rules.md` | cascade rules | 해당 단계 진입 시 |
| `references/corpus-en-slogans.md` | corpus en slogans | 해당 단계 진입 시 |
| `references/corpus-hall-of-fame.md` | corpus hall of fame | 해당 단계 진입 시 |
| `references/corpus-ko-patterns.md` | corpus ko patterns | 해당 단계 진입 시 |
| `references/corpus-writing-rules-KIWI.md` | corpus writing rules KIWI | 해당 단계 진입 시 |
| `references/cross-ab-testing.md` | cross ab testing | 해당 단계 진입 시 |
| `references/cross-brand-voice.md` | cross brand voice | 해당 단계 진입 시 |
| `references/cross-channel-matrix.md` | cross channel matrix | 해당 단계 진입 시 |
| `references/cross-funnel-map.md` | cross funnel map | 해당 단계 진입 시 |
| `references/cross-length-constraints.md` | cross length constraints | 해당 단계 진입 시 |
| `references/cross-tone-system.md` | cross tone system | 해당 단계 진입 시 |
