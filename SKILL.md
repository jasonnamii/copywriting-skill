...
## §4.8. UX_WRITING_MODE — A계열·CRM 필수, 기타 선택

**허브:** `@ref: references/ux-principles.md#A-N2,N5,N9,N10`. 이 스킬은 N2·N5·N9·N10 코어 4원리 적용.

**발동:** A계열(A1~A10 앱 카피) · D계열(D1~D3 CRM) · C계열 내 에러·안내 카피. B계열(문서)·C계열 내 브랜딩/마케팅은 스킵.
...
- 🟡 Experimental 차단 맥락(에러·법적·결제)은 기존 §1 축2 규칙대로 ⚪ Standard 강제 — UX_WRITING_MODE는 그 **위에** 4원리 검증 추가.
...
| 9 | A·D계열 카피에 UX_WRITING_MODE 스킵 | §4.8 4원리 검증 필수. 에러 메시지 "원인만" = N9 FAIL |
| 10 | 시스템 용어를 그대로 노출 (N2 위반) | "400 Bad Request" → 사용자 언어로 번역. 에러코드는 작게 별도 표기 |
