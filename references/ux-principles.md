...
5개 UX 스킬(ui-action-designer·app-architect·design-skill·copywriting-skill·html-div-style)이 참조하는 단일 허브. **풀텍스트는 여기에만**, 스포크는 `@ref: _shared/ux-principles.md#N` 포인터만 유지.
